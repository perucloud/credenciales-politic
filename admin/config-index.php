...
<div class="max-w-4xl mx-auto space-y-6" x-data="{ activeTab: '<?= htmlspecialchars($active_tab, ENT_QUOTES) ?>' }">
  ...
  <div class="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-3">
    ...
    <a href="<?= BASE_URL ?>/index.php?preview=1" target="_blank" class="inline-flex items-center gap-2 text-xs font-bold text-gray-500 hover:text-[#049CD4] border border-gray-200 rounded-xl px-4 py-2 bg-white transition-colors">Ver sitio</a>
  </div>
